...
namespace EScript
{
    ...
    : ExtObject(other), codeFragment(other.codeFragment), line(other.line), paramCount(other.paramCount),
      minParamValueCount(other.minParamValueCount), maxParamValueCount(other.maxParamValueCount),
      multiParam(other.multiParam), instructions(other.instructions), staticData(other.staticData)
    {
    }
