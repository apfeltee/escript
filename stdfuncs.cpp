            ...
            ES_FUNCTION(globals, "clock", 0, 0,
                        {
                            ...
                            return static_cast<double>(time.QuadPart - _clockStart.QuadPart)
        ...
        ES_FUNCTION(globals, "eval", 1, 2,
                    {
                        ...
                        return _eval(rt, CodeFragment(Consts::FILENAME_INLINE, StringData(parameter[0].toString())), staticVars);
                    })
        ...
        ES_FUNCTION(globals, "ord", 1, 2,
                    {
                        ...
                        = parameter[0].to<const String*>(rt)->_getStringData().getCodePoint(parameter[1].toInt(0));
        ...
        ES_FUNCTION(globals, "parse", 1, 1,
                    {
                        ...
                        auto compileUnit = compiler.compile(
                        CodeFragment(Consts::FILENAME_INLINE, StringData(parameter[0].toString())), injectedStaticVars);
