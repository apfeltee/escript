...
namespace EScript
{
    ...
    void Bool::init(EScript::Namespace& globals)
    {
        ...
        //! Bool Bool & ((Bool)obj)
        ES_FUN(typeObject, "&", 1, 1, (thisEObj->toBool() & parameter[0].toBool()) > 0)
        ...
        //! [ESMF] Bool |= Bool
        ES_MFUN(typeObject, Bool, "|=", 1, 1, (thisObj->setValue(thisEObj->toBool() | parameter[0].toBool()), thisEObj))
        ...
        //! [ESMF] Bool Bool > ((Bool)obj)
        ES_FUN(typeObject, ">", 1, 1, (thisEObj->toBool() > parameter[0].toBool()))
